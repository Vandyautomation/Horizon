...
export default function AndonOverallDashboard() {
  ...
  const [sortConfig, setSortConfig] = useState<{
    key: 'timestamp' | 'MchLoc' | 'MchNumber'
    direction: 'asc' | 'desc'
  }>({
    key: 'timestamp',
    direction: 'desc',
  ...
  const [selectedCard, setSelectedCard] = useState<Building | undefined>(
    undefined
  )
  ...
  const handleMouseMove = (e: MouseEvent) => {
    if (isDragging) {
      ...
      if (resizeDirection?.includes('w')) {
        ...
        setPosition((prev) => ({
          ...prev,
          x: position.x + (resizeStart.width - newWidth),
        }))
      }
      ...
      if (resizeDirection?.includes('n')) {
        ...
        setPosition((prev) => ({
          ...prev,
          y: position.y + (resizeStart.height - newHeight),
        }))
      }
  ...
  const handleSort = (key: 'timestamp' | 'MchLoc' | 'MchNumber') => {
    setSortConfig((prev) => {
      if (prev.key === key) {
        return {
          key,
  ...
  const sortedMachines = selectedCard
    ? [...selectedCard.machines].sort((a, b) => {
        ...
        if (key === 'timestamp') {
          valueA =
            a.timestamp && a.timestamp !== '1970-01-01T00:00:00.000Z'
              ? new Date(a.timestamp).getTime()
              : 0

          valueB =
            b.timestamp && b.timestamp !== '1970-01-01T00:00:00.000Z'
    ...
    <div className="w-full h-full ">
      <div className="flex items-center justify-between">
        <Image
          ...
          width={200}
          height={100}
          className="px-3 py-2 flex items-center border border-gray-250 rounded-xl text-gray-700 align-middle bg-white"
        />
        ...
        <div className="mb-4">
          <div className="grid grid-cols-11 gap-2 mt-2">
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-4xl font-bold">
                    {buildings?.reduce(
                      (acc, building) => acc + building.machines.length,
                      0
                    ) || 0}
                  </span>
                </div>
            ...
            <Card
              ...
              onClick={() => {
                const buildingsWithOrangeMachines = buildings?.filter(
                  (building) =>
            ...
            <Card
              ...
              onClick={() => {
                const buildingsWithGreenMachines = buildings?.filter(
                  (building) =>
            ...
            <Card
              ...
              onClick={() => {
                const buildingsWithWhiteMachines = buildings?.filter(
                  (building) =>
            ...
            <Card
              ...
              onClick={() => {
                const buildingsWithPurpleMachines = buildings?.filter(
                  (building) =>
            ...
            <Card
              ...
              onClick={() => {
                const buildingsWithBlueMachines = buildings?.filter(
                  (building) =>
            ...
            <Card
              ...
              onClick={() => {
                const buildingsWithYellowMachines = buildings?.filter(
                  (building) =>
              ...
              <div className="mb-2" key={`${building.id}-${location}`}>
                <div className="grid grid-cols-11 gap-2 mt-2">
                  ...
                  <Card
                    className="bg-orange-500 text-white cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationOrangeMachines =
                        buildings?.find((building) =>
                          building.machines.some(
                            (m) =>
                      ...
                      if (buildingWithLocationOrangeMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationOrangeMachines.machines.filter(
                              (m) =>
                                m.MchLoc === location && m.status === 'ORANGE'
                            ),
                        })
                  ...
                  <Card
                    className="bg-green-600 text-white cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationGreenMachines = buildings?.find(
                        (building) =>
                          building.machines.some(
                            (m) => m.MchLoc === location && m.status === 'GREEN'
                          )
                      )
                      if (buildingWithLocationGreenMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationGreenMachines.machines.filter(
                              (m) =>
                  ...
                  <Card
                    className="bg-gray-100 text-black cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationWhiteMachines = buildings?.find(
                        (building) =>
                          building.machines.some(
                            (m) => m.MchLoc === location && m.status === 'WHITE'
                          )
                      )
                      if (buildingWithLocationWhiteMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationWhiteMachines.machines.filter(
                              (m) =>
                  ...
                  <Card
                    className="bg-purple-500 text-white cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationPurpleMachines =
                        buildings?.find((building) =>
                          building.machines.some(
                            (m) =>
                      ...
                      if (buildingWithLocationPurpleMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationPurpleMachines.machines.filter(
                              (m) =>
                                m.MchLoc === location && m.status === 'PURPLE'
                            ),
                        })
                  ...
                  <Card
                    className="bg-blue-500 text-white cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationBlueMachines = buildings?.find(
                        (building) =>
                          building.machines.some(
                            (m) => m.MchLoc === location && m.status === 'BLUE'
                          )
                      )
                      if (buildingWithLocationBlueMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationBlueMachines.machines.filter(
                              (m) =>
                  ...
                  <Card
                    className="bg-yellow-400 text-black cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationYellowMachines =
                        buildings?.find((building) =>
                          building.machines.some(
                            (m) =>
                      ...
                      if (buildingWithLocationYellowMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationYellowMachines.machines.filter(
                              (m) =>
                                m.MchLoc === location && m.status === 'YELLOW'
                            ),
                        })
                  ...
                  <Card
                    className="bg-red-500 text-white cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationRedMachines = buildings?.find(
                        (building) =>
                          building.machines.some(
                            (m) => m.MchLoc === location && m.status === 'RED'
                          )
                      )
                      if (buildingWithLocationRedMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationRedMachines.machines.filter(
                              (m) => m.MchLoc === location && m.status === 'RED'
                            ),
                        })
                      }
                  ...
                  <Card
                    className="bg-gray-500 text-white cursor-pointer"
                    onClick={() => {
                      const buildingWithLocationGreyMachines = buildings?.find(
                        (building) =>
                          building.machines.some(
                            (m) => m.MchLoc === location && m.status === 'GREY'
                          )
                      )
                      if (buildingWithLocationGreyMachines) {
                        setSelectedCard({
                          ...
                          machines:
                            buildingWithLocationGreyMachines.machines.filter(
                              (m) =>
        ...
        >
          ...
          >
            <CardTitle className="flex justify-between items-center cursor-move mb-4">
              {selectedCard.machines.length > 0 &&
              new Set(selectedCard.machines.map((m) => m.MchLoc)).size > 1 ? (
                <>
                  All Buildings - Status{' '}
                  {
                    statusLabels[
                      selectedCard.machines[0]
                        .status as keyof typeof statusLabels
                    ]
                  }{' '}
                  ({selectedCard.machines.length} machines)
                </>
              ) : (
                <>
                  {selectedCard.name} Status{' '}
                  {
                    statusLabels[
                      selectedCard.machines[0]
                        .status as keyof typeof statusLabels
              ...
              <TableHeader className="p-0">
                <TableRow>
                  ...
                  <TableHead
                    ...
                    onClick={() => handleSort('MchNumber')}
                  >
                    Mch Number{' '}
                    {sortConfig.key === 'MchNumber'
                  ...
                  <TableHead
                    className="w-[100px] cursor-pointer"
                    onClick={() => handleSort('MchLoc')}
                  >
                    Mch Loc{' '}
                    {sortConfig.key === 'MchLoc'
                      ? sortConfig.direction === 'asc'
                        ? '▲'
                        : '▼'
                      : ''}
          ...
          <CardContent className="p-4 pt-0">
            <div className="grid grid-cols-1 gap-4">
              {/* Resize handles */}
              <div
                className="resize-handle absolute top-0 right-0 w-2 h-2 cursor-se-resize"
              ...
              />
              <div
                className="resize-handle absolute top-0 left-1/2 w-2 h-2 cursor-n-resize"
                onMouseDown={(e) => handleResizeStart(e, 'n')}
              />
              <div
                className="resize-handle absolute bottom-0 left-1/2 w-2 h-2 cursor-s-resize"
                onMouseDown={(e) => handleResizeStart(e, 's')}
              />
              <div
                className="resize-handle absolute top-1/2 left-0 w-2 h-2 cursor-w-resize"
                onMouseDown={(e) => handleResizeStart(e, 'w')}
              />
              <div
                className="resize-handle absolute top-1/2 right-0 w-2 h-2 cursor-e-resize"
                onMouseDown={(e) => handleResizeStart(e, 'e')}
              />
              <Table>
                <TableBody>
                      ...
                      <TableRow key={machine.MchID}>
                        ...
                        <TableCell
                          ...
                          style={{
                            color:
                              statusColors[
                                machine.status as keyof typeof statusColors
                              ],
                          }}
                        >
                          {
                            statusLabels[
                              machine.status as keyof typeof statusLabels
                            ]
                          }
                        </TableCell>
                          ...
                          {machine.timestamp !== '' ? (
                            (() => {
                              ...
                              if (diffMins < 60) {
                                ...
                                machine.timestamp === '1970-01-01T00:00:00.000Z'
                              ) {
                                return 'Never'
                              } else {

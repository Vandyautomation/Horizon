...
import { Bot, Calculator, Clock, Cpu, Database, Lightbulb, SprayCan, Zap, Container, Wrench, Ticket } from "lucide-react";
    ...
    <div className="h-full flex flex-col space-y-8 p-8 md:flex">
      <div>
        ...
        <div className="grid grid-cols-7 py-4 gap-4">
          ...
          <Link href="/ems_setting" passHref legacyBehavior>
            <a className="w-full">
              <Card className="flex items-center justify-center hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer h-full">
                <CardContent className="text-center pt-6">
                  <Label
          ...
          <Link href="/zhafir-ze-3600" passHref legacyBehavior>
            <a className="w-full">
              <Card className="flex items-center justify-center hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer h-full">
                <CardContent className="text-center pt-6">
                  <Label
          ...
          <Link href="/hrz" passHref legacyBehavior>
              <a className="w-full">
                <Card className="flex items-center justify-center hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer h-full">
                  <CardContent className="text-center pt-6">
                    <Label
          ...
          {!user ? null : (
            <Link href="/assignment-worklist" passHref legacyBehavior>
              <a className="w-full">
                <Card className="flex items-center justify-center hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer h-full">
                  <CardContent className="text-center pt-6">
                    <Label

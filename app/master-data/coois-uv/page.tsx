...
export default function CooisUvUpload() {
  ...
  return (
    <div className="p-4 w-full mx-auto">
      <Card>
        <CardHeader>
          <CardTitle className="">Excel File Upload COOIS UV</CardTitle>
        </CardHeader>
        <CardContent>
            <div className="grid grid-cols-3 gap-4">
                <div>
                    <p className="">Perhatikan hal-hal berikut sebelum upload :</p>
                    <p className="">1. Pastikan data sudah benar, yaitu COOIS UV</p>
                    ...
                    <p className="flex">6. Download contoh file COOIS UV : <><a href="/admin/contoh_coois_uv.xlsx" download className="text-secondary-foreground underline flex items-center">Download Contoh COOIS <Download size={16}/></a></></p>
                </div>
                <div
